   ...
   */
  //int ERROR_RETURNED;
  DEBUG_SERIAL.println("[  INFO  ] EXECUTING P2PCSP... ");
  ...
  DEBUG_SERIAL.print("[  INFO  ] SETTING DXL GP[0] : "); DEBUG_SERIAL.println(dxl_goal_position[0]);
  DEBUG_SERIAL.print("[  INFO  ] SETTING DXL GP[1] : "); DEBUG_SERIAL.println(dxl_goal_position[1]);
  DEBUG_SERIAL.print("[  INFO  ] SETTING DXL GP[2] : "); DEBUG_SERIAL.println(dxl_goal_position[2]);
