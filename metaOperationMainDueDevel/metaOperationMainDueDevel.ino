...
// Auxiliary Libraries
#include <definitions.h>                              // [2%] Includes definitions of control table variables addresses/data lengths/ communication/ protocols
//#include <definitions_progmem.h>
...
char SESSION_MAIN_DIR_POS[15];
char SESSION_MAIN_DIR_VEL[15];
char SESSION_MAIN_DIR_FORCE[15];
char LOG_POS[20];  // prev 14
char LOG_VEL[20];
char LOG_FORCE[20];
